...
import dev.endoy.configuration.yaml.comments.YamlCommentDumper;
import dev.endoy.configuration.yaml.comments.YamlCommentMapper;
import dev.endoy.configuration.yaml.comments.YamlCommentParser;
...
public class YamlConfiguration extends YamlSection implements IConfiguration
{
    ...
    public YamlConfiguration( final InputStream input, final ConfigurationOptions options ) throws IOException
    {
        ...
        if ( input != null )
        {
            try ( InputStream inputStream = input; InputStreamReader reader = new InputStreamReader( inputStream ) )
            {
